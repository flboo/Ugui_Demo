...
namespace Com.TheFallenGames.OSA.CustomAdapters.DateTimePicker
{
	...
	/// or drag and drop the prefab in /OSA/Resources/OSA/DateTimePicker8 into your scene and subscribe to <see cref="OnDateSelected"/>
	/// </summary>
	public class DateTimePickerDialog : MonoBehaviour
	{
		...
		{
			var go = Resources.Load<GameObject>("OSA/" + typeof(DateTimePickerDialog).Name);
