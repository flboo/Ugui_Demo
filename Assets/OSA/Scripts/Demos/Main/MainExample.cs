...
namespace Com.TheFallenGames.OSA.Demos.Main
{
	...
	/// </summary>
	public class MainExample : OSA<MyParams, ClientItemViewsHolder>, ExpandCollapseOnClick.ISizeChangesHandler
	{
		...
		protected override ClientItemViewsHolder CreateViewsHolder(int itemIndex)
		{
			...
			instance.expandCollapseComponent.useUnscaledTime = _Params.UseUnscaledTime;
		...
		{
			//if (_Params.Data.Count > OSAConst.MAX_ITEMS_TO_SUPPORT_ITEM_RESIZING)
			//	return false;
