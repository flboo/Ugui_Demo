...
namespace Com.TheFallenGames.OSA.Demos.Common
{
	...
	{
		public const string OSA_PATH_RELATIVE_TO_PROJECT = "Assets/OSA";
		public const string OSA_SCENES_PATH_RELATIVE_TO_PROJECT = OSA_PATH_RELATIVE_TO_PROJECT + "/" + SCENES_FOLDER_NAME;
		public const string OSA_SCENES_PATH_RELATIVE_TO_ASSETS = "OSA/" + SCENES_FOLDER_NAME;
